...
(function () {
    var module = angular.module('kladr', ['ngSanitize']);
    ...
    module.directive('serverMonitoring', [
        'suggestionService', '$sce', '$q', function (suggestionService, $sce, $q) {
            ...
            return {
                ...
                templateUrl: function (elem, attrs) {
                    ...
                    var fullTemplatePath = host + '/js/internal/directives/kladrSelectorTemplate.html';
                ...
                link: function (scope, element, attrs) {
                    ...
                    scope.showLabels = attrs.showLabels;
